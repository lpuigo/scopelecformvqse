...
// GetRecordColNumByName returns given columns names positions in a record (or error if not found in header)
...
// Add aads given records in the RecordSet and returns their row numbers
...
// Get returns the record at given row number
